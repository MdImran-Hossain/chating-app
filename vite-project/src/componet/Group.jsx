...
const Group = ({
  ...
  return (
    <>
            ...
            <div className={`${GroupBorder} flex justify-center items-center pt-[14px] pb-[10px] border-b-2 border-b-[rgba(0,0,0,0.25)]`}>
          ...
          <div
            className={`px-[20px] text-[20px] font-semibold cursor-pointer font-poppins bg-bandColor rounded-xl ${GroupBtnDesing}`}
          >
            {GroupBtn}
          </div>
        </div>
